...
hidden if the `Chess_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Chess_DEVELOPER_MODE` to the configure
...
Runs the executable target `Chess_exe`.
